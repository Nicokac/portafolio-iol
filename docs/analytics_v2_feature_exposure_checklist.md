...
| Planeacion | Shortlist unificada de futuras compras | UI completa | `Planeacion` | selectors incrementales de dashboard | Unifica backlog nuevo y reactivadas para destacar que propuesta conviene reconsiderar primero. |
| Planeacion | Workflow superior de futuras compras | UI completa | `Planeacion` | selectors incrementales de dashboard | Expone fuente mas solida, propuesta `Recomendada ahora`, acciones directas y estado superior del workflow. |
