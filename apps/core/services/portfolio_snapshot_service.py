...
class PortfolioSnapshotService:
    ...
    def generate_daily_snapshot(self, target_date: date = None) -> PortfolioSnapshot:
        ...
        snapshot_payload = {
            ...
            "total_patrimonio_modelado": kpis.get("total_patrimonio_modelado"),
            "cash_disponible_broker": kpis.get("cash_disponible_broker"),
            "caucion_colocada": kpis.get("caucion_colocada"),
