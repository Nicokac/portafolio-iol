...
class IncrementalProposalSnapshot(models.Model):
    ...
    decision_confidence = models.CharField(max_length=16, null=True, blank=True)
    decision_explanation = models.JSONField(null=True, blank=True)
    macro_state = models.CharField(max_length=24, null=True, blank=True)
    portfolio_state = models.CharField(max_length=24, null=True, blank=True)
