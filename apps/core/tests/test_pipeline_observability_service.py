...
def test_pipeline_observability_service_builds_unified_summary():
    class DummySyncAuditService:
        def run_audit(self, freshness_hours=24):
            ...
            return {
                ...
                "snapshots": {
                    "status": "ok",
                    "latest_sync": type("DummyDT", (), {"isoformat": lambda self: "2026-03-17T10:00:00"})(),
                },
            }
    ...
    assert summary["last_successful_iol_sync"] == "2026-03-17T10:00:00"
    assert summary["iol_sync_status"] == "ok"
    assert summary["latest_asset_snapshot_at"] == "2026-03-17T10:00:00-03:00"
    assert summary["latest_account_snapshot_at"] == "2026-03-17T10:00:00-03:00"
