...
class TestDashboardSelectors(TestCase):
    ...
    def test_get_manual_incremental_portfolio_simulation_comparison_uses_operational_tiebreak_when_scores_are_close(self):
            ...
            def simulate(self, proposal):
                ...
                if symbols == {"KO", "MCD"}:
                    return {
                        ...
                        "interpretation": "Plan manual A queda apenas arriba por score.",
                        "warnings": [],
                    }
                return {
                    "before": {},
                    ...
                    "interpretation": "Plan manual B queda muy cerca.",
                    "warnings": [],
                }
        ...
        assert detail["best_proposal_key"] == "plan_b"
        assert detail["proposals"][0]["proposal_key"] == "plan_b"
    ...
    def test_get_candidate_incremental_portfolio_comparison_uses_operational_tiebreak_for_close_candidates(self):
        cache.clear()
            ...
            def simulate(self, proposal):
                ...
                if symbol == "KO":
                    return {
                        ...
                        "interpretation": "KO queda apenas arriba por score.",
                        "warnings": [],
                    }
                return {
                    "before": {},
                    ...
                    "interpretation": "MCD queda muy cerca.",
                    "warnings": [],
                }
        ...
        assert detail["best_proposal_key"] == "MCD"
