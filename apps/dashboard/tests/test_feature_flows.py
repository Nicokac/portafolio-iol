...
class TestDashboardFeatureFlows:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("dashboard:planeacion", "dashboard/planeacion.html", ["kpis", "portafolio", "senales_rebalanceo", "monthly_allocation_plan", "candidate_asset_ranking", "incremental_portfolio_simulation", "incremental_portfolio_simulation_comparison"]),
