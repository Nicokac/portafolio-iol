...
class TestDashboardFeatureFlows:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("dashboard:planeacion", "dashboard/planeacion.html", ["kpis", "portafolio", "senales_rebalanceo", "monthly_allocation_plan", "candidate_asset_ranking", "incremental_portfolio_simulation", "preferred_incremental_portfolio_proposal", "incremental_proposal_history", "incremental_proposal_tracking_baseline", "incremental_followup_executive_summary", "incremental_baseline_drift", "incremental_snapshot_vs_current_comparison", "incremental_portfolio_simulation_comparison", "candidate_incremental_portfolio_comparison", "candidate_split_incremental_portfolio_comparison", "manual_incremental_portfolio_simulation_comparison"]),
